...
//this class conforms to the gesture recognizer delegate protocol:
...
- (id) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|[_commentLabel]|"
                                                                                 ...
                                                                                 metrics:nil
                                                                                   views:viewDictionary]];
        //these three views should be stacked vertically, from the top, with no space in between
        [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|[_mediaImageView][_usernameAndCaptionLabel][_commentLabel]"
                                                                                 options:kNilOptions
                                                                                 metrics:nil
                                                                                   views:viewDictionary]];
        //set each view's height to 100 points
        //height is equal to (nothing * 1) + 100
...
- (void) layoutSubviews {
    ...
    //account for the possibility of missing data in our views
...
//if the user swipes the cell to show the delete button, then taps on the cell, the expected behavior is to hide the delete button (not to zoom in on the image)
//to accomplish this, we make sure the geseture recognizer only fires while the cell isn't in editing mode:
