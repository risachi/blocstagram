...
- (void)viewDidLoad {
    ...
    // generate the load and appropriate login site in the web view
...
//searches for a URL containing the redirect URI, then sets th eaccess token to everything after access_token=
//for example, if your redirect URL is http://bloc.io, Instagram could send you to http://bloc.io?access_token=MY_TOP_SECRET_TOKEN
//we'd then set accessToken equal to MY_TOP_SECRET_TOKEN and post the notification
