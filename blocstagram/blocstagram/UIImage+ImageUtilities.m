...
- (UIImage *) imageWithFixedOrientation {
    ...
    //create a CGContextRef (a "bitmap graphics context", like a blank sheet of paper you can draw on)
    ...
    //scale the image (to support Retina displays)
    CGContextScaleCTM(ctx, scaleFactor, scaleFactor);
    //apply transform to the drawing context with CGContextConcatCTM, and draw the transformed image from the graphics context using CGContextDrawImage
