...
- (void) addRandomData {
    ...
    for (int i = 1; i <= 10; i++) {
        ...
        // ...creates a media model for it, attaches a randomly generated user to it, adds a random caption...
        ...
        if (image) {
            ...
            // ...and puts each media item into the mediaItems array
...
- (void) requestNewItemsWithCompletionHandler:(NewItemCompletionBlock)completionHandler {
    ...
    if (self.isRefreshing == NO) {
        ...
        // we create a new random media object and append itt ot he front of the KVC array; we place the media item at index 0 because that is the index of the top-most table-cell (later this will be changed to access the Instagram API)
        Media *media = [[Media alloc] init];
        media.user = [self randomUser];
