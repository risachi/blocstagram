...
//when the camera button is pressed, present the view controller within a navigation controller and dismiss it with a note when the delegate method is called
